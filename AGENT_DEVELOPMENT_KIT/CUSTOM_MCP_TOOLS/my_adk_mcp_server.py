...
# Suppress warnings that might be printed to stdout/stderr and confuse the MCP client
warnings.filterwarnings("ignore")

# Save original print to avoid recursion
_original_print = builtins.print

# Use stderr for logging to avoid corrupting the MCP stdio protocol on stdout
def safe_print(*args, **kwargs):
    kwargs.setdefault('file', sys.stderr)
    _original_print(*args, **kwargs)

# Override the global print to ensure all output goes to stderr
